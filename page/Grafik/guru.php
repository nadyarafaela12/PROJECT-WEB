...
$laki =mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM tb_guru WHERE jk='Laki-laki' "));
$pr =mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM tb_guru WHERE jk='Perempuan' "));
?>
  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Grafik Data Guru SD Swasta Muhammdiyah',
          is3D: true,
        };
