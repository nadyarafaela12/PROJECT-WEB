...
$carikode = mysqli_query($koneksi, "SELECT max(id_pengangkat) from tb_lbg_pengangkat") or die(" ");
...
<label class="form-label">Nama Lembaga</label>
                ...
                mysqli_query($koneksi, "INSERT INTO tb_lbg_pengangkat VALUES ('$id_pengangkat','$nama_lembaga')") or die(" ");
                ?>
...
-->           
                        ...
                        $sql_user = mysqli_query($koneksi, "SELECT * from tb_lbg_pengangkat limit $posisi,$batas" ) or die(" ");
                        $no =$posisi + 1;
 ...
 // Script update data
    if (isset($_REQUEST['update'])) {
        ...
        $nama_lembaga = $_REQUEST['nama_lembaga'];  
         ...
         mysqli_query($koneksi, "UPDATE tb_lbg_pengangkat SET 
                                      nama_lembaga='$nama_lembaga'
                                      WHERE id_pengangkat='$id_pengangkat'") or die(" ");
          ?>
<script type="text/javascript">
...
<!-- Akhir Modal Edit-->
                                ...
                                <?php
                                include 'koneksi/-koneksi.php';
                                $jml =mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM tb_lbg_pengangkat"));
