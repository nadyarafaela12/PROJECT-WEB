...
$carikode = mysqli_query($koneksi,"SELECT max(id_status) from tb_status") or die(" ");
...
<label class="form-label">Nama Status</label>
                ...
                mysqli_query($koneksi, "INSERT INTO tb_status VALUES ('$id_status','$nama_status')") or die(" ");
                ?>
...
-->           
                        ...
                        $sql_user = mysqli_query($koneksi, "SELECT * from tb_status limit $posisi,$batas" ) or die(" ");
                        $no =$posisi + 1;
 ...
 // Script update data
    if (isset($_REQUEST['update'])) {
        ...
        $nama_status = $_REQUEST['nama_status'];  
         ...
         mysqli_query($koneksi, "UPDATE tb_status SET 
                                      nama_status='$nama_status'
                                      WHERE id_status='$id_status'") or die("");
          ?>
<script type="text/javascript">
...
<!-- Akhir Modal Edit-->
                                ...
                                <?php
                                include 'koneksi/-koneksi.php';
                                $jml =mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM tb_status"));
