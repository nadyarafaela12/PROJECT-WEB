...
$carikode = mysqli_query($koneksi, "SELECT max(id_jenjang) from tb_jenjang") or die(" ");
...
<label class="form-label">Jenjang Pendidikan</label>
                ...
                mysqli_query($koneksi, "INSERT INTO tb_jenjang VALUES ('$id_jenjang','$nama_jenjang')") or die(" ");
                ?>
...
-->           
                        ...
                        $sql_user = mysqli_query($koneksi, "SELECT * from tb_jenjang limit $posisi,$batas" ) or die(" ");
                        $no =$posisi + 1;
 ...
 // Script update data
    if (isset($_REQUEST['update'])) {
        ...
        $nama_jenjang = $_REQUEST['nama_jenjang'];  
         ...
         mysqli_query($koneksi, "UPDATE tb_jenjang SET 
                                      nama_jenjang='$nama_jenjang'
                                      WHERE id_jenjang='$id_jenjang'") or die(" ");
          ?>
<script type="text/javascript">
...
<!-- Akhir Modal Edit-->
                                ...
                                <?php
                                include 'koneksi/-koneksi.php';
                                $jml =mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM tb_jenjang"));
