...
$carikode = mysqli_query($koneksi,"SELECT max(id_sumbergaji) from tb_sumber_gaji") or die("");
...
<label class="form-label"> Sumber Gaji</label>
                ...
                mysqli_query($koneksi, "INSERT INTO tb_sumber_gaji VALUES ('$id_sumbergaji','$sumber_gaji')") or die("");
                ?>
...
-->           
                        ...
                        $sql_user = mysqli_query($koneksi, "SELECT * from tb_sumber_gaji limit $posisi,$batas" ) or die("");
                        $no =$posisi + 1;
 ...
 // Script update data
    if (isset($_REQUEST['update'])) {
        ...
        $sumber_gaji = $_REQUEST['sumber_gaji'];  
         ...
         mysqli_query($koneksi, "UPDATE tb_sumber_gaji SET 
                                      sumber_gaji='$sumber_gaji'
                                      WHERE id_sumbergaji='$id_sumbergaji'") or die(" ");
          ?>
<script type="text/javascript">
...
<!-- Akhir Modal Edit-->
                                ...
                                <?php
                                include 'koneksi/-koneksi.php';
                                $jml =mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM tb_sumber_gaji"));
