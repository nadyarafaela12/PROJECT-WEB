...
$kdpeg = @$_GET['kdpeg'];
$sql = mysqli_query($koneksi, "SELECT * from tb_pegawai where no_urut = '$kdpeg'") or die("");
...
?>
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-xs-12 ol-sm-12 col-md-12 col-lg-12">
                                    ...
                                    include 'koneksi/-koneksi.php';
                                    $kdpeg = @$_GET['kdpeg'];
                                    $sql1 = mysqli_query($koneksi,"SELECT * from tb_pendidikan where id_pend = '$kdpeg'") or die("");
                                    ...
                                    include 'koneksi/-koneksi.php';
                                    $kdpeg = @$_GET['kdpeg'];
                                    $sql2 = mysqli_query($koneksi, "SELECT * from tb_diklat where id_diklat = '$kdpeg'") or die("");
        ...
        <p class="text-center">
         ...
         <a href="javascript:history.back()" class="btn btn-warning pull-right"><i class="material-icons">fast_rewind</i> </a>       
                        ...
                        @$id_sumbergaji = mysqli_real_escape_string($koneksi,$_POST['id_sumbergaji']);
                        ...
                        $query= mysqli_query($koneksi, "UPDATE tb_pegawai SET nip ='$nip',
                        ...
                        $query1=mysqli_query($koneksi, "UPDATE tb_pendidikan SET nip='$nip', jenjang ='$jenjang',
                            satuan_pendidikan='$satuan_pendidikan',
                            tahun_masuk='$tahun_masuk',
                            tahun_lulus='$tahun_lulus' WHERE id_pend='$kdpeg' ");

                        $query2= mysqli_query($koneksi, "UPDATE tb_diklat SET nip='$nip', jenis_diklat ='$jenis_diklat',
