...
$kdpeg = @$_GET['kdpeg'];
$sql = mysqli_query($connection, "select tb_pegawai.*,tb_pendidikan.*,tb_diklat.* from tb_pegawai,tb_pendidikan,tb_diklat where tb_pegawai. no_urut=tb_pendidikan.id_pend=tb_diklat.id_diklat = '$kdpeg'") or die("");
...
?>
     ...
     <?php
                                ...
                                $sql = mysqli_query("SELECT tb_pegawai.*,tb_pendidikan.*,tb_diklat.* from tb_pegawai,tb_pendidikan,tb_diklat where tb_pegawai. no_urut=tb_pendidikan.id_pend=tb_diklat.id_diklat") or die ("");
                                $no=1;
