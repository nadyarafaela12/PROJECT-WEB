...
$carikode = mysqli_query($koneksi, "SELECT max(id_pangkat) from tb_pangkat") or die("Perintah anda tidak di temukan");
...
<label class="form-label">Nama Golongan</label>
                ...
                mysqli_query($koneksi, "INSERT INTO tb_pangkat VALUES ('$id_pangkat','$nama_golongan')") or die("Perintah anda tidak ditemukan");
                ?>
...
-->           
                        ...
                        $sql_user = mysqli_query($koneksi, "SELECT * from tb_pangkat limit $posisi,$batas" ) or die("Data tidak ditemukan");
                        $no =$posisi + 1;
                        $cek =mysqli_num_rows($sql_user);
                        if($cek < 1){
 ...
 // Script update data
    if (isset($_REQUEST['update'])) {
        ...
        $nama_golongan = $_REQUEST['nama_golongan'];  
         ...
         mysqli_query($koneksi, "UPDATE tb_pangkat SET nama_golongan='$nama_golongan' WHERE id_pangkat='$id_pangkat'") or die("Data tidak ditemukan");
          ?>
<script type="text/javascript">
...
<!-- Akhir Modal Edit-->
        ...
        <?php
        include 'koneksi/-koneksi.php';
        $jml =mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM tb_pangkat"));
