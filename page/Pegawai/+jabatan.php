...
$carikode = mysqli_query($koneksi, "SELECT max(id_jabatan) from tb_jabatan") or die(" ");
...
mysqli_query($koneksi, "INSERT INTO tb_jabatan VALUES ('$id_jabatan','$nama_jabatan')") or die(" ");
?>
...
-->           
                        ...
                        $sql_user = mysqli_query($koneksi, "SELECT * from tb_jabatan limit $posisi,$batas" ) or die(" ");
                        $no =$posisi + 1;
 ...
 // Script update data
    if (isset($_REQUEST['update'])) {
        ...
        $nama_jabatan = $_REQUEST['nama_jabatan'];  
         ...
         mysqli_query($koneksi, "UPDATE tb_jabatan SET 
                                      nama_jabatan='$nama_jabatan'
                                      WHERE id_jabatan='$id_jabatan'") or die(" ");
          ?>
<script type="text/javascript">
...
<!-- Akhir Modal Edit-->
                                ...
                                <?php
                                include 'koneksi/-koneksi.php';
                                $jml =mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM tb_jabatan"));
