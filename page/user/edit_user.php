...
$kduser = @$_GET['kduser'];
$sql = mysqli_query($koneksi,"SELECT * from tb_user where kode_user = '$kduser'") or die("");
...
mysqli_query($koneksi,"update tb_user set nama='$nama', username='$username',pass='$pass',password =md5('$pass'), level='$level' where kode_user='$kduser' ") or die("");
  ?>
