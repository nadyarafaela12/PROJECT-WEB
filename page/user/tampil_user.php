...
$carikode = mysqli_query($koneksi,"SELECT max(kode_user) from tb_user") or die("");
...
if ($pindah) {
mysqli_query($koneksi,"insert into tb_user values ('$kode_user','$nama','$username','$password','$pass','$level','$nama_gambar')") or die ("");
?>
            ...
            <div class="col-xs-12 ol-sm-12 col-md-12 col-lg-12">
             <div class="table table-responsive">                            
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <?php
                                include 'koneksi/-koneksi.php';
                                $sql = mysqli_query($koneksi,"SELECT * from tb_user") or die ("");
                                $no=1;
