...
define('mpdf60/') require_once("mpdf60/mpdf.php");
...
<div id="header" align="center" style="font-family: Cooper Black; ">
  ...
  <b>DATA GURU </b><br>
  Sekolah Dasar Swasta Muhammadiyah
...
<div align="center" style="border:1px solid;">
  <table border="1" style="border-collapse: collapse;">
    ...
    <th>Telepon</th> 
      ...
      <?php
include "koneksi.php";
$sql = mysqli_query($koneksi, "SELECT * from tb_guru") or die("");
$no=1;
...
<div id="footer" align="right">
  <b>Muhammadiyah,<?php echo date (" d F Y") ?></b><br>
